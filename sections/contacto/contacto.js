...
<section id="contacto" class="contacto">
  <div class="contacto__glow" aria-hidden="true"></div>
  ...
  <div class="container">
    ...
    <div class="contacto__inner reveal">
      ...
      <h2 class="contacto__title">
        ¿Listo para transformar tu<br>empresa con <span>IA soberana</span>?
      </h2>
      <p class="contacto__sub">
        Habla con nuestros expertos y descubre cómo Mayia puede
        impulsar tu organización con inteligencia artificial hecha en México.
      </p>

      <a
        href="mailto:contacto@mayia.mx"
        class="contacto__email-btn"
        aria-label="Enviar correo a Mayia"
      >
